...
import ipnet.gl.code_fusion_api.mapper.PermissionMapper;
import ipnet.gl.code_fusion_api.repository.PermissionRepository;
...
public class PermissionServiceImpl implements PermissionService {
    ...
    public PermissionResponse create(PermissionRequest request) {
        ...
        Permission savedEntity = repository.save(entity);
        return mapper.toResponse(savedEntity);
    }
    
    @Override
    public PermissionResponse update(UUID trackingId, PermissionRequest request) {
        Permission entity = repository.findByTrackingId(trackingId)
            .orElseThrow(() -> new ResourceNotFoundException("Permission", "trackingId", trackingId));
        
        mapper.updateEntityFromRequest(request, entity);
        entity.setTrackingId(trackingId);
        Permission updatedEntity = repository.save(entity);
    ...
    public PermissionResponse findByTrackingId(UUID trackingId) {
        Permission entity = repository.findByTrackingId(trackingId)
            .orElseThrow(() -> new ResourceNotFoundException("Permission", "trackingId", trackingId));
    ...
    @Override
    @Transactional(readOnly = true)
    public List<PermissionResponse> search(String term) {
